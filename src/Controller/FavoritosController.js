...
const FavoritosController = {
    async criar(req, res) {
        ...
        //     mensagem: mensagem,
        // }
        let sql = `insert into favoritos (usuarios_id, canil_id) VALUES(?,?)`
        const result = await pool.query(sql, [usuarios_id, canil_id])
    ...
    async alterar(req, res){
        ...
        let sql = 'UPDATE favoritos SET usuarios_id=?, canil_id=? WHERE id = ?'
